...
class Model_Opponent extends \Orm\Model
{
    ...
    public static function validate($factory)
    {
        ...
        $val->add_field('opponent_name', 'Opponent Name',
                        'required|max_length[162]');
        $val->add_field('opponent_mascot', 'Opponent Mascot', 'max_length[162]');
        $val->add_field('opponent_current', 'Opponent Current',
                        'valid_string[numeric]');
        $val->add_field('opponent_short', 'Opponent Short',
                        'required|max_length[30]');
        $val->add_field('opponent_abbr', 'Opponent Abbr',
