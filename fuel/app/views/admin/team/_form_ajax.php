<?= Form::open(['action' => 'ajax/team/create', 'id' => 'ajax_form_team']); ?>
<fieldset>
    
    <div class="form-group">
        <?= Form::label('Sport', 'sport_id', ['class' => 'control-label']); ?>

        <?= Form::select('sport_id', Input::post('sport_id', isset($team) ? $team->sport_id : ''), [], ['class' => 'form-control', 'placeholder' => 'Team name']); ?>
    </div>
    ...
    <div class="form-group">
        <?= Form::submit('ajax_team', 'Save', ['class' => 'btn btn-primary']); ?>
